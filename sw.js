...
const OFFLINE_CACHE_FILES = [
     'https://ilhamsanusi27.blogspot.com/p/offline.html',
];

const NOT_FOUND_CACHE_FILES = [
    'https://ilhamsanusi27.blogspot.com/p/not-found.html',
];

const OFFLINE_PAGE = 'https://ilhamsanusi27.blogspot.com/p/offline.html';
const NOT_FOUND_PAGE = 'https://ilhamsanusi27.blogspot.com/p/not-found.html';
...
//    (str) => {
//        return !str.includes('/wp-admin/') || !str.startsWith('https://ilhamku.site//wp-admin/');
//    },
];
